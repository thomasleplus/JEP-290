...
/**
 * Serializes then immediately deserializes a {@link BigInteger} -- the kind of Java deserialization
 * that a JEP 290 serialization filter is designed to inspect and constrain.
 */
